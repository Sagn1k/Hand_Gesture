...
\title{A unified framework for the recognition of raised finger in a static hand posture}
...
We have used gestures G1, G2, G3, G4 and G5 which are shown with their respective extracted Region of Interest.
\begin{figure}[!h]
\begin{tabular}{ccccc}
...
\centering
\begin{tabular}{ccc}
\subfloat[\, \, \, \, \, RGB Image]{\includegraphics[width = 0.55in]{res1}} &
\subfloat[\, \, \, \, \, \, \,Skin Likelihood]{\includegraphics[width = 0.55in]{res2}} &
\subfloat[Segmented Image]{\includegraphics[width = 0.55in]{res3}}
\end{tabular}
%\caption{Gestures used with extracted ROI}
\end{figure}
...
\end{figure}
We applied our algorithms on standard Massey University database \cite{barczak2011new} of images available online.We used 5 hand gestures from the data-set. The skin segments taken to calibrate our Gaussian skin model were randomly taken from the people of the same ethnicity as that of the dataset.
...
\midrule
\texttt{{\fontfamily{cmr}\selectfont G1}} &0.9275  &  0.0725  & 0  & 0 & 0\\
\texttt{{\fontfamily{cmr}\selectfont G2}} &0  &  1  & 0  & 0 & 0\\ 
\texttt{{\fontfamily{cmr}\selectfont G3}} &0  &  0  & 0.92  & 0.08 & 0\\
\texttt{{\fontfamily{cmr}\selectfont G4}} &0  &  0  & 0.014  & 0.972 & 0.014\\
\texttt{{\fontfamily{cmr}\selectfont G5}} &0  &  0  & 0  & 0.0923 & 0.8616\\
        \bottomrule             
\end{tabular}
\end{table}
...
\textbf{Actual Class} & \multicolumn{1}{c}{G1} & \multicolumn{1}{c}{G2} & \multicolumn{1}{c}{G3} & \multicolumn{1}{c}{G4} & \multicolumn{1}{c}{G5} \\
\midrule
\texttt{{\fontfamily{cmr}\selectfont G1}} &0.884  &  0.116  & 0  & 0 & 0\\
\texttt{{\fontfamily{cmr}\selectfont G2}} &0.0143  &  0.9429  & 0.0428  & 0 & 0\\
\texttt{{\fontfamily{cmr}\selectfont G3}} &0.0133  &  0.12  & 0.8534  & 0.0133 & 0\\
\texttt{{\fontfamily{cmr}\selectfont G4}} &0.014  &  0.014  & 0.07  & 0.888 & 0.014\\
\texttt{{\fontfamily{cmr}\selectfont G5}} &0  &  0  & 0  & 0.0615 & 0.9385\\
        \bottomrule             
\end{tabular}
\end{table}
...
To have an understanding of real\- time results, we collect our database of images and further test the accuracy. Ten pictures of ten different individuals were taken. The skin segments taken to calibrate our Gaussian skin model were randomly taken from the skin samples of people of various ethnicity and region like North Indians, South Indians, North \- East Indians to test the robustness of our algorithm.
...
\textbf{Actual Class} & \multicolumn{1}{c}{G1} & \multicolumn{1}{c}{G2} & \multicolumn{1}{c}{G3} & \multicolumn{1}{c}{G4} & \multicolumn{1}{c}{G5} \\
\midrule
\texttt{{\fontfamily{cmr}\selectfont G1}} &1  &  0  & 0  & 0 & 0\\
\texttt{{\fontfamily{cmr}\selectfont G2}} &0  &  0.9  & 0.1  & 0 & 0\\ 
\texttt{{\fontfamily{cmr}\selectfont G3}} &0  &  0  & 1  & 0 & 0\\
\texttt{{\fontfamily{cmr}\selectfont G4}} &0  &  0  & 0  & 1 & 0\\
\texttt{{\fontfamily{cmr}\selectfont G5}} &0  &  0  & 0  & 0.3 & 0.7\\
        \bottomrule             
\end{tabular}
\end{table}
